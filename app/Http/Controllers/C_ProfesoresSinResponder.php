...
class C_ProfesoresSinResponder extends Controller
{
    public function Index(){
        ...
        ->select('profesor.id_profesor','profesor.cedula','asignatura.nombre','grupo.cod_grupo','profesor_asignatura_grupo.semestre','profesor_asignatura_grupo.año')
        ...
        return view('P_ProfesoresSinResponder')->with('profesor',$profesor);
